...
const performanceData: Performance[] = [
  ...
  // ✅ 新增：Forest Preparatory School 文化周（2026年2月23日）
  {
    id: '4',
    date: '2026-02-23',
  ...
  return (
    <section id="performances" className="section-padding bg-brand-dark">
      <div className="container-custom">
        ...
        >
          <h2 className="heading-lg text-brand-gold mb-6">Artistic Journey</h2>
          <p className="text-gray-400 max-w-2xl mx-auto">
            A selection of performances, collaborations, and cultural events that have shaped my musical journey., educational institutions, and charity events.
          </p>
        </motion.div>
